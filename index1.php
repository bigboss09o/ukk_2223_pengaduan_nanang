...
<head>
  ...
  <title>Web Laporan Masyarakat</title>
...
<body>
  ...
  <header id="header" class="fixed-top  header-transparent ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.php">Yukk Lapor!!</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="popup-with-form" href="#test-form">Login Admin/Petugas</a></li>
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            <h1>Web Laporan Masyarakat</h1>
            <h2>
              Pengaduan Masyarakat <br>
              Selamat datang di website pengaduan masyarakat <br>
              Silahkan login dengan akun anda. 
            </h2>
            <a href="registrasi.php" class="download-btn">Registrasi</a>
            <a href="Login/index.php" class="download-btn">Login</a>
          </div>
        </div>
