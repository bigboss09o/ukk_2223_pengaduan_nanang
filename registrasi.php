                            ...
                            <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                                <div class="Appointment">
                                    ...
                                    <div class="book_btn d-none d-lg-block">
                                        <a href="#registrasi"><i class="fa fa-user-plus"></i>  Halaman Registrasi</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
...
?>
    ...
    <!-- project  -->
    <div class="project_area" id="registrasi">
...
<tr>
<td><h7>KONFIRMASI PASSWORD</h7></th><td><input type="text" name="pass" class="form_input2" required="required"  placeholder="Password"></td>
</tr>
<tr>
