                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text">
                                ...
                                <p>Selamat datang di web Pengaduan Masyarakat<br>
                                ...
                                <div class="video_service_btn">
                                    ...
                                    <a href="Masyarakat/index.php" class="boxed-btn3"> <i class="fa fa-sign-in"></i>
                                        Login Masyarakat</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                <h3> Tentang Lapor<br>
                                    Pengaduan Masyarakat</h3>
                                <p>Website ini digunakan untuk penyampaian keluhan masyarakat<br>
                                    kepada pihak yang berwenang atau pelayanan yang tidak sesuai dengan <br>
                                    standart pelayanan atau pengabaian yang dilakukan oleh pemerintah.</p>
                                <div class="video_service_btn">
                                    <a href="registrasi.php" class="boxed-btn3"><i class="fa fa-user-plus"> Registrasi disini</i></a>
                                    <a href="Masyarakat/index.php" class="boxed-btn3"> <i class="fa fa-sign-in"></i>
                                        Login Masyarakat</a>
