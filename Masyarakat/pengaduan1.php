...
<td><?=$data ['status'] ?></td>
<td>
    <a class="btn btn-success" style="float:left" href="tanggapan_masyarakat.php?id=<?php echo $data['isi_laporan'] ?>" role="button"><i class="fa fa-eye"></i> Lihat Tanggapan</a></p>
<a onClick="return confirm('Yakin Ingin Menghapus?')" class="btn btn-danger" href="hapus_pengaduan1.php?id=<?php echo $data['id_pengaduan'] ?>" role="button"><i class="fa fa-remove"></i>Hapus</a>
<a class="btn btn-success" href="edit_data_pengaduan.php?id=<?php echo $data['id_pengaduan'] ?>" role="button"><i class="fa fa-pencil"></i> Edit</a>
<?php }}else{
